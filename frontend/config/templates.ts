...
export const WORKSPACE_TEMPLATES: WorkspaceTemplate[] = [
  {
    ...
    settings: { itemLabel: 'Application', primaryFieldLabel: 'Company' },
  },
  {
    id: 'lead-sales',
    name: 'Lead / Sales',
    ...
    settings: { itemLabel: 'Lead', primaryFieldLabel: 'Company' },
  },
  {
    id: 'property',
    name: 'Property',
    ...
    settings: { itemLabel: 'Property', primaryFieldLabel: 'Name' },
  },
  {
    id: 'project',
    name: 'Project',
    ...
    settings: { itemLabel: 'Project', primaryFieldLabel: 'Title' },
  },
  {
    id: 'custom',
    name: 'Custom',
    ...
    stages: [],
    settings: { itemLabel: 'Item', primaryFieldLabel: 'Name' },
  },
]
